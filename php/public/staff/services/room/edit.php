...
if(is_post_request()) {
    ...
    $cus_room = [];
    $cus_room['customer_id'] = $customer_id;
    ...
    if($result === true) {
        redirect_to(url_for('/staff/services/room/show.php?id=' . $customer_id));
    } else {
        $errors = $result;
        //var_dump($errors);
    }
...
-->
        <div class="Edit Shop Record">
            ...
            <form action="<?php echo url_for('/staff/services/room/edit.php?id=' . h(u($customer_id))); ?>" method="post">
